...
class CartItemAdapterWithLike(
	...
	inner class ViewHolder(private val binding: CartListItemBinding) :
		...
		fun bind(itemData: UserData.CartItem) {
			...
			val proData = proList.find { it.productId == itemData.inventoryId } ?: Product()
