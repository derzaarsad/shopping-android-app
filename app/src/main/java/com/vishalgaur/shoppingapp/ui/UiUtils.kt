...
enum class AddProductViewErrors { NONE, ERR_NAME_EMPTY, ERR_UPC_EMPTY, ERR_UNIT_EMPTY, ERR_CAT_EMPTY }

enum class AddInventoryViewErrors { NONE, ERR_SUPPLIER_EMPTY, ERR_PRODUCT_EMPTY, ERR_MINSELLPRICE_NOT_BIGGER, ERR_QUANTITY_0, ERR_PURCHASE_PRICE_EMPTY, ERR_ORDERNUM_EMPTY, ERR_SKU_EMPTY, ERR_IMG_EMPTY, ERR_NOT_FUTURE_DATE }

enum class AddAddressViewErrors { EMPTY, ERR_NAME_EMPTY, ERR_STR1_EMPTY, ERR_CITY_EMPTY, ERR_STATE_EMPTY, ERR_ZIP_EMPTY, ERR_ZIP_INVALID, ERR_PHONE_INVALID, ERR_PHONE_EMPTY }

enum class AddProductCategoryViewErrors { NONE, EMPTY }

enum class AddSupplierViewErrors { NONE, EMPTY }

enum class AddItemErrors { ERROR_QUANTITY }
