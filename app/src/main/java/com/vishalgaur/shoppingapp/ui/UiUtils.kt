...
enum class AddInventoryViewErrors { NONE, ERR_SUPPLIER_EMPTY, ERR_PRODUCT_EMPTY, ERR_QUANTITY_0, ERR_PURCHASE_PRICE_EMPTY, ERR_ORDERNUM_EMPTY, ERR_SKU_EMPTY, ERR_IMG_EMPTY, ERR_NOT_FUTURE_DATE }
